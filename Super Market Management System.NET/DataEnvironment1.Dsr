...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   _ExtentY        =   18256
   FolderFlags     =   1
   TypeLibGuid     =   "{3FF4C045-00BF-4A83-A236-D5D049FC0EF6}"
   TypeInfoGuid    =   "{D615C55B-D97B-4841-AC43-791B0B97780F}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\project\db\customer.mdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
